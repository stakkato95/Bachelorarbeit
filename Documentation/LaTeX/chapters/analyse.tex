...
\begin{description} 
	...
	\item[Transparenz.] Überbrückung der Kluft zwischen lokaler und nicht lokaler Concurrency. Transparenz ist derzeit ein umstrittenes Thema. Einige Wissenschaftler befürworten eine strikte Trennung zwischen lokaler Concurrency mit Concurrent Programmiersprachen (z.B. Java und C#) und nicht lokaler Concurrency mit REST \footnote{Representational state transfer} für Webdienste. Eine klare Trennung schafft Probleme, wenn es wünschenswert oder notwendig ist, von lokalen Diensten auf Webdienste umzusteigen.
